...
\item
  extensions: \url{https://exts.ggplot2.tidyverse.org/gallery/}
\item
  ggmosaic: this package has been removed from CRAN, it is necessary to
  install and older version:
\end{enumerate}

Download and install RTools from
``\url{https://cran.rstudio.com/bin/windows/Rtools/rtools45/rtools.html}''

Download ggmosaic running install.packages( ``ggmosaic'', repos =
c(``\url{https://haleyjeppson.r-universe.dev}'',
...
\pandocbounded{\includegraphics[keepaspectratio]{a_files/figure-latex/hist_adults-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{a_files/figure-latex/plot_adults-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{a_files/figure-latex/plot_adr-1.pdf}}
In this case, we observe that only one value is significantly higher
than the rest. We consider it an outlier and eliminate it, as well as
the negative values which have no a clear explanation, although we keep
the 0 values:
...
\pandocbounded{\includegraphics[keepaspectratio]{a_files/figure-latex/hist_adr-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{a_files/figure-latex/descdist-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{a_files/figure-latex/hist_adr_tipo-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{a_files/figure-latex/violin_adr_tipo-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{a_files/figure-latex/ggstatsplot-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{a_files/figure-latex/country-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{a_files/figure-latex/mosaic_hotel_is_canceled-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{a_files/figure-latex/mosaic_country_is_canceled-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{a_files/figure-latex/dia-1.pdf}}
EXERCISE: Improve and split the above graph by hotel type or country of
origin.
